...
namespace SyringeCore {
    class CoreApi {
    public:
        Events::ModuleLoadEvent onModuleLoaded;
        /**
         ...
         */
        virtual void** syHook(const u32 address, const void* function, int moduleId = -1);
        /**
         ...
         */
        virtual void** syHookEx(const u32 address, const void* function, int options, int moduleId = -1);
        /**
         * @brief Injects a hook at the target address.
         * @note Hooks injected via this function WILL automatically return execution to the original function.
         *
         ...
         */
        DEPRECATE virtual void syInlineHook(const u32 address, const void* replacement);
        /**
         ...
         */
        DEPRECATE virtual void syInlineHookRel(const u32 offset, const void* replacement, int moduleId);
        /**
         ...
         */
        DEPRECATE virtual void sySimpleHook(const u32 address, const void* replacement);
        /**
         ...
         * @param moduleId ID of the target module
         */
        DEPRECATE virtual void sySimpleHookRel(const u32 offset, const void* replacement, int moduleId);
        /**
         ...
         */
        DEPRECATE virtual void syReplaceFunc(const u32 address, const void* replacement, void** original);
        /**
